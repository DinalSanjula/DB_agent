...
from api_models import InsertProposalRequest, InsertProposalResponse, InsertApprovalResponse, InsertApprovalRequest
...
async def approve_proposal(request:InsertApprovalRequest,
                           session: AsyncSession=Depends(get_db)):
